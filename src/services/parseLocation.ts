 ...
 *
 * Tablas de aliases en `locationAliases.ts`, helpers de texto en `locationTextUtils.ts`.
 */

import airportsData from "../database/seeds/data/airports.json";
import {
  CITIES_MULTI_AIRPORT,
  CITY_TO_IATA,
  COUNTRY_3LETTER,
  COUNTRY_TEXT_TO_ISO2,
  IATA_ALIASES,
  IATA_AMBIGUOUS_PER_COUNTRY,
  RAW_OVERRIDES,
} from "./locationAliases";
import { cleanCity, normKey, splitFirstSegment } from "./locationTextUtils";
